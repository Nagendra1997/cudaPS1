...
void preProcess(uchar4 **inputImage, unsigned char **greyImage,
  ...
  *greyImage  = imageGrey.ptr<unsigned char>(0);
  ...
  checkCudaErrors(cudaMalloc(d_rgbaImage, sizeof(uchar4) * numPixels));cudaDeviceSynchronize();
  checkCudaErrors(cudaMalloc(d_greyImage, sizeof(unsigned char) * numPixels));cudaDeviceSynchronize();
